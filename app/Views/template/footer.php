	...
	<div class="footer-top">
		<div class="container-fluid">
			...
			<div class="col-xs-4 w3l-rightmk">
				<img src=<?php echo base_url('images/tab3.png')?> alt=" ">
			</div>
		...
		<div class="container">
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src=<?php echo base_url('images/pay2.png')?> alt="">
						</li>
						<li>
							<img src=<?php echo base_url('images/pay5.png')?> alt="">
						</li>
						<li>
							<img src=<?php echo base_url('images/pay1.png')?> alt="">
						</li>
						<li>
							<img src=<?php echo base_url('images/pay4.png')?> alt="">
						</li>
						<li>
							<img src=<?php echo base_url('images/pay6.png')?> alt="">
						</li>
						<li>
							<img src=<?php echo base_url('images/pay3.png')?> alt="">
						</li>
						<li>
							<img src=<?php echo base_url('images/pay7.png')?> alt="">
						</li>
						<li>
							<img src=<?php echo base_url('images/pay8.png')?> alt="">
						</li>
						<li>
							<img src=<?php echo base_url('images/pay9.png')?> alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<script src=<?php echo base_url('js/stylecontrol.js');?>></script>
